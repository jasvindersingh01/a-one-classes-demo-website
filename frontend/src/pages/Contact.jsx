  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        "https://a-one-classes-demo-website.onrender.com/api/contact",
        {
          method: "POST",
          headers: {
  ...
  return (
    <section className="pb-20 bg-gray-50">
      ...
      <div className="max-w-8xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 px-6 md:px-20 mb-16">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="bg-white p-10 rounded-2xl shadow-xl space-y-6 border-l-4 border-blue-700">
        ...
        >
          ...
          <motion.button
            ...
            className={`bg-blue-700 text-white px-6 py-3 rounded-lg w-full font-semibold transition
    ${loading ? "bg-blue-400 cursor-not-allowed" : "hover:bg-blue-800"}`}
      ...
      <motion.div
        ...
        transition={{ duration: 0.7 }}
        viewport={{ once: true }}
        className="w-full h-[350px] md:h-[450px] shadow-xl"
      >
        <iframe
