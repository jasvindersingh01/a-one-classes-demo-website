...
import VisionImg from "../assets/about/vision.avif";
  ...
  return (
    ...
    <section className="py-20 bg-gray-50 min-h-screen px-6 md:px-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
        ...
        {/* Mission */}
        {/* Mission & Vision Section */}
{/* Mission - Full Width Section */}
<motion.div
  initial={{ opacity: 0, y: 30 }}
  whileInView={{ opacity: 1, y: 0 }}
  transition={{ duration: 0.7 }}
  className="flex flex-col md:flex-row items-center gap-12 bg-white p-10 rounded-2xl shadow-xl mt-20"
>
  {/* Left Text */}
...
{/* Vision - Full Width Section */}
<motion.div
  initial={{ opacity: 0, y: 30 }}
  whileInView={{ opacity: 1, y: 0 }}
  transition={{ duration: 0.7 }}
  className="flex flex-col md:flex-row-reverse items-center gap-12 bg-white p-10 rounded-2xl shadow-xl mt-14"
>
  {/* Right Text */}
  <div className="md:w-1/2">
    <h2 className="text-3xl md:text-4xl font-bold text-blue-700 mb-4">
